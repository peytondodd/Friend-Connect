    ...
    <div class="container">
      ...
      <div class="login mt-4">
        <form class="" action="<?php echo URLROOT; ?>/login" method="post">
          <div class="text-center">
            <div class="form-row">
              <div class="col-5">
                <input class="form-control" type="email" name="login_email" placeholder="Email" value="<?php echo isset($data['login_email']) ? $data['login_email'] : ''; ?>">
              </div>
              <div class="col-5">
      ...
      <div class="register">
        <div class="row logo-container">
          ...
          <div class="col-6">
            <a class="float-right btn btn-outline-success login-hide" href="#">Log in</a>
          </div>
        </div>
        ...
        <form class="registerform" action="<?php echo URLROOT; ?>/register" method="post">
          <div class="form-row form-group">
            <div class="col-md-6">
              <input class="form-control <?php echo !empty($data['first_name_err']) ? "is-invalid" : "is-valid"; ?>" type="text" name="first_name" placeholder="First name" value="<?php echo isset($data['first_name']) ? $data['first_name'] : ''; ?>">
              <div class="invalid-feedback">
                <?php echo $data['first_name_err']; ?>
              </div>
            </div>
            <div class="col-md-6">
              <input class="form-control <?php echo !empty($data['last_name_err']) ? "is-invalid" : "is-valid"; ?>" type="text" name="last_name" placeholder="Last name" value="<?php echo isset($data['last_name']) ? $data['last_name'] : ''; ?>">
              <div class="invalid-feedback">
          ...
          <div class="form-group">
            <input class="email form-control <?php echo !empty($data['register_email_err']) ? "is-invalid" : "is-valid"; ?>" type="email" name="register_email" placeholder="Email" value="<?php echo isset($data['register_email']) ? $data['register_email'] : ''; ?>">
            <div class="invalid-feedback">
              <?php echo $data['register_email_err']; ?>
            </div>
          </div>
          <div class="form-group">
            <input class="form-control confirm-email <?php echo !empty($data['confirm_register_email_err']) ? "is-invalid" : "is-valid"; ?>" <?php echo !empty($data['confirm_register_email_err']) || !empty($data['confirm_register_email']) ? "style='display:block';" : "style='display:none';";?> type="email" name="confirm_register_email" placeholder="Confirm email" value="<?php echo isset($data['confirm_register_email']) ? $data['confirm_register_email'] : ''; ?>">
            <div class="invalid-feedback">
              <?php echo $data['confirm_register_email_err']; ?>
            </div>
          </div>
          <div class="form-group">
            <input class="password form-control <?php echo !empty($data['password_err']) ? "is-invalid" : "is-valid"; ?>" type="password" name="password" placeholder="Password">
            <div class="invalid-feedback">
              <?php echo $data['password_err']; ?>
            </div>
          </div>
          <div class="form-group">
            <input class="form-control confirm-password <?php echo !empty($data['confirm_password_err']) ? "is-invalid" : "is-valid"; ?>" <?php echo !empty($data['confirm_password_err']) && !empty($data["confirm_password"]) ? "style='display:block';" : "style='display:none';";?> type="password" name="confirm_password" placeholder="Confirm password">
            <div class="invalid-feedback">
          ...
          <div class="register-submit">
            ...
            <p class="haveAccount float-right">Have an account? <a href="#">Log in</a></p>
          </div>
        </form>
      </div>
